    ...
    $.get(API_SERVER + '/courses_api/lesson/read/' + lesson_id,
        ...
        flashcards.forEach((flashcard) => {
            ...
            if(flashcard.lesson_type == "video_file"){
                $("#theSlide").append('<div class="'+className+'"><div alt="title_text" style="height:500px; width: 500px;"><h1> '+flashcard.question+'</h1><video controls style="height:500px; width:1000px;"> <source src= "'+flashcard.image+'"></video></div></div>')
            }
